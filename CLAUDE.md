...
- Migraciones 001–020 y 022 aplicadas en producción (022 el 2026-09-13). **La 021 (catálogo de planes) sigue sin aplicar** hasta configurar Stripe; no depende de ella la 022. Antes de aplicar una nueva, comprobar el estado con `supabase db query --linked`.
