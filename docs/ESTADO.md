...
- ⏳ **Pendiente de decisión de José:** (1) audios: dictado por voz en el navegador o notas de voz transcritas por un proveedor externo (nuevo subencargado RGPD); (2) si con el despacho (no con clientes) Carlota puede analizar documentos a fondo, lo que cambia la regla "nunca interpretas documentos"; (3) Word/Excel (requieren conversión).
