...
- ⏳ **Pendiente de decisión de José:** (1) audios: dictado por voz en el navegador o notas de voz transcritas por un proveedor externo (nuevo subencargado RGPD); (2) ~~análisis a fondo para el despacho~~ → sí, nivel despacho; (3) Word/Excel (requieren conversión).
